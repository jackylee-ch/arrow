...
std::vector<NativeFunction> GetArithmeticFunctionRegistry() {
  static std::vector<NativeFunction> arithmetic_fn_registry_ = {
      ...
      BINARY_SYMMETRIC_SAFE_INTERNAL_NULL(mod, {"modulo"}, int8, int8, int8),
      BINARY_SYMMETRIC_SAFE_INTERNAL_NULL(mod, {"modulo"}, int16, int16, int16),
      BINARY_SYMMETRIC_SAFE_INTERNAL_NULL(mod, {"modulo"}, int32, int32, int32),
      BINARY_SYMMETRIC_SAFE_INTERNAL_NULL(mod, {"modulo"}, int64, int64, int64),
